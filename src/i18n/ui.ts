...
export const ui = {
  nl: {
    ...
    'about.founder.description.p3':
      'Daarom begon ik 15 jaar geleden met het uitbouwen van een breed gamma aan unieke activiteiten. Hierbij stond persoonlijk contact met de klant voorop.',
    'about.founder.description.p4':
      'Het is mijn overtuiging dat bedrijven een leuke dag moeten hebben zonder zorgen, zodat hun werknemers als een versterkt team uit de ervaring komen.',
    ...
    'about.values.resultaat.description':
      'We focussen op het versterken van teams en meetbare resultaten',
  ...
  fr: {
    ...
    'about.founder.description.p1':
      "Mon père avait sa propre agence événementielle. Après ma formation d'escrimeur de haut niveau, j'ai commencé à organiser des initiations à l'escrime.",
    'about.founder.description.p2':
      "J'étais frustré de voir que de nombreuses entreprises de team building n'écoutaient pas assez leurs clients et organisaient toujours les mêmes activités, souvent de manière amateur.",
    'about.founder.description.p3':
      "C'est pourquoi j'ai commencé il y a 15 ans à développer une large gamme d'activités uniques. Le contact personnel avec le client était la priorité.",
    'about.founder.description.p4':
      "Je suis convaincu que les entreprises doivent passer une bonne journée sans soucis, afin que leurs employés ressortent de l'expérience en équipe renforcée.",
    'about.founder.image.alt': 'Frederiek Troubleyn',
    ...
    'about.values.persoonlijk.description':
      'Le contact personnel et le sur-mesure sont au cœur de notre approche',
    'about.values.resultaat.title': 'Résultat',
    'about.values.resultaat.description':
      'Nous nous concentrons sur le renforcement des équipes et des résultats mesurables',
