const id = "en/teambooster.md";
						const collection = "activities";
						const slug = "en/teambooster";
						...
						const data = {title:"TeamBooster",description:"Where activities are designed to stimulate the team and where collaboration is the key to success.",image:"teambooster/teambooster-1.jpg",categories:["outdoor"],duration:"2 - 5 hours",groupSize:"8 - 1000 people",availability:"All year round",priority:18,features:["Communication","Creativity","Coaching in option","Collaboration"],gallery:["teambooster/teambooster-2.jpg","teambooster/teambooster-3.jpg","teambooster/teambooster-4.jpg","teambooster/teambooster-5.jpg","teambooster/teambooster-6.jpg","teambooster/teambooster-7.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/en/teambooster.md",
							rawData: undefined,
						};
