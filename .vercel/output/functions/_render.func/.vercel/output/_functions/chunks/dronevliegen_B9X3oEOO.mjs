const id = "nl/dronevliegen.md";
						const collection = "activities";
						const slug = "nl/dronevliegen";
						...
						const data = {title:"Dronevliegen",description:"Leer, Ervaar en Ontdek!",image:"dronevliegen/dronevliegen-1.jpg",categories:["innovaction","indoor"],duration:"1 - 2.5 uur",groupSize:"8 - 250 personen",availability:"Op aanvraag",priority:3,features:["Leer de basis","Oefenen","Teamuitdaging"],gallery:["dronevliegen/dronevliegen-2.jpg","dronevliegen/dronevliegen-3.jpg","dronevliegen/dronevliegen-4.jpg","dronevliegen/dronevliegen-5.jpg","dronevliegen/dronevliegen-6.jpg","dronevliegen/dronevliegen-7.jpg"],"video-url":"https://iframe.mediadelivery.net/embed/369439/d1ad05d2-54ab-4b52-8e64-2943ff452f8b",isGame:false,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/nl/dronevliegen.md",
							rawData: undefined,
						};
