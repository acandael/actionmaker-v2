import { c as createAstro, a as createComponent, m as maybeRenderHead, e as renderComponent, b as addAttribute, f as renderTemplate, r as renderSlot } from './astro/server_D1OCFpJj.mjs';
import 'kleur/colors';
import { $ as $$Image } from './_astro_assets_BkT240b4.mjs';
...
import { g as getLangFromUrl, u as useTranslations, B as Button } from './Footer_C-XPWC84.mjs';
/* empty css                         */
import { g as getCollection } from './_astro_content_BRUEO5_Q.mjs';
import { C as Card, a as CardContent } from './card_t7Z17QZZ.mjs';
import 'clsx';
...
const $$FAQAccordion = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="w-full"> <div id="faq-root"${addAttribute(JSON.stringify(faqs), "data-faqs")}>  </div> </div> `;
