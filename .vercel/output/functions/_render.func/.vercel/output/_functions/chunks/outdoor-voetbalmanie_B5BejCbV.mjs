...
const html = "<p>Duik in de voetbalsfeer met een reeks unieke activiteiten (vb: voetbalbowling, voetbaldarts, mini kicker, voetbalquiz, …) die speciaal zijn ontworpen voor het voetbalevenement van het jaar.</p>\n<p>Of je nu een fervent voetbalfan bent of gewoon op zoek bent naar plezier en competitie, deze activiteiten beloven een onvergetelijke ervaring vol voetbalenthousiasme. Doe mee, scoor doelpunten en geniet van de opwinding van het EK voetbal op een geheel nieuwe manier!</p>";
				...
				const frontmatter = {"title":"Voetbalmanie (Outdoor)","description":"Beleef het voetbal op een geheel nieuwe manier met onze speciaal ontwikkelde activiteit","image":"outdoor-voetbalmanie/outdoor-voetbalmanie-1.jpg","priority":25,"isGame":true,"features":["Voetbalbowling","Voetbaldarts","Voetbalquiz","Voetbalsnooker","Mini Kicker"],"gallery":["outdoor-voetbalmanie/outdoor-voetbalmanie-2.jpg","outdoor-voetbalmanie/outdoor-voetbalmanie-3.jpg","outdoor-voetbalmanie/outdoor-voetbalmanie-4.jpg","outdoor-voetbalmanie/outdoor-voetbalmanie-5.jpg"],"categories":["outdoor"],"duration":"30 minuten - 2 uur","groupSize":"8 - 200 personen","availability":"Op aanvraag"};
				const file = "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/nl/outdoor-voetbalmanie.md";
				const url = undefined;
				function rawContent() {
