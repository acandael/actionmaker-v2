const id = "en/excalibur.md";
						const collection = "activities";
						const slug = "en/excalibur";
						...
						const data = {title:"Excalibur",description:"This activity places complete emphasis on collaboration",image:"excalibur/excalibur-1.jpg",categories:["outdoor","actief"],duration:"2 - 5 hours",groupSize:"8 - 500 people",availability:"On request",priority:19,features:["Adventure","Team building","Competition"],gallery:["excalibur/excalibur-2.jpg","excalibur/excalibur-3.jpg","excalibur/excalibur-4.jpg","excalibur/excalibur-5.jpg","excalibur/excalibur-6.jpg","excalibur/excalibur-7.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/en/excalibur.md",
							rawData: undefined,
						};
