const id = "fr/gentse-stroppentocht.md";
						const collection = "activities";
						const slug = "fr/gentse-stroppentocht";
						...
						const data = {title:"Jeu de Ville à Gand",description:"Team building à Gand : Découvrez, Jouez & Gagnez !",image:"gentse-stroppentocht/gentse-stroppentocht-1.jpg",categories:["city-games"],duration:"2-3 heures",groupSize:"6 - 150 personnes",availability:"Sur demande",priority:1,features:["Chasse aux photos: Patershol","Golf urbain: Vrijdagsmarkt","Apprenez les expressions gantoises avec l'alphabet sémaphore","Repérage de graffitis: Werregarenstraat","Quiz tout au long du parcours","Dégustation de gin et/ou de jus de fruits","En option: Défis supplémentaires","Prix pour les gagnants!"],gallery:["gentse-stroppentocht/gentse-stroppentocht-1.jpg","gentse-stroppentocht/gentse-stroppentocht-2.jpg","gentse-stroppentocht/gentse-stroppentocht-3.jpg","gentse-stroppentocht/gentse-stroppentocht-4.jpg","gentse-stroppentocht/gentse-stroppentocht-5.jpg","gentse-stroppentocht/gentse-stroppentocht-6.jpg","gentse-stroppentocht/gentse-stroppentocht-7.jpg"],isGame:false,isCityGame:true};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/fr/gentse-stroppentocht.md",
							rawData: undefined,
						};
