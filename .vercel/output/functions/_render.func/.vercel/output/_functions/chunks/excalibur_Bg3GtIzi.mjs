const id = "nl/excalibur.md";
						const collection = "activities";
						const slug = "nl/excalibur";
						...
						const data = {title:"Excalibur",description:"Deze activiteit legt de volledige nadruk op samenwerking",image:"excalibur/excalibur-1.jpg",categories:["outdoor","actief"],duration:"2 - 5 uur",groupSize:"8 - 500 personen",availability:"Op aanvraag",priority:19,features:["Avontuur","Teambuilding","Competitie"],gallery:["excalibur/excalibur-2.jpg","excalibur/excalibur-3.jpg","excalibur/excalibur-4.jpg","excalibur/excalibur-5.jpg","excalibur/excalibur-6.jpg","excalibur/excalibur-7.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/nl/excalibur.md",
							rawData: undefined,
						};
