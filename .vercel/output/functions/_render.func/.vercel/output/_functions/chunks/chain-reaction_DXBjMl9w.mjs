const id = "en/chain-reaction.md";
						const collection = "activities";
						const slug = "en/chain-reaction";
						...
						const data = {title:"Chain Reaction",description:"Together we will work to create an impressive Goldberg machine",image:"chain-reaction/chain-reaction-1.jpg",categories:["indoor"],duration:"2 - 5 hours",groupSize:"6 - 800 people",availability:"On request",priority:13,features:["challenge and creativity","abundance of materials and possibilities","teamwork","spectacular finish"],gallery:["chain-reaction/chain-reaction-2.jpg","chain-reaction/chain-reaction-3.jpg","chain-reaction/chain-reaction-4.jpg","chain-reaction/chain-reaction-5.jpg","chain-reaction/chain-reaction-6.jpg","chain-reaction/chain-reaction-7.jpg"],"video-url":"https://iframe.mediadelivery.net/embed/369439/e893044e-8fc5-4c2e-bfc5-79d2976065f1",isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/en/chain-reaction.md",
							rawData: undefined,
						};
