const id = "fr/smaaktest.md";
						const collection = "activities";
						const slug = "fr/smaaktest";
						...
						const data = {title:"Test de Dégustation",description:"Pouvez-vous faire confiance à votre goût ? Qui fait le meilleur usage des sens du goût, de l'odorat et du toucher?",image:"smaaktest/smaaktest-1.jpg",categories:["workshop"],duration:"2 - 5 heures",groupSize:"8 - 250 personnes",availability:"Tout l'année",priority:3,features:["Savez-vous quelles épices vous utilisez dans vos plats ? Pouvez-vous les reconnaître sans l'étiquette ?","Essayez d'identifier votre fromage ou vos épices préférés, uniquement au goût.","Reconnaissez-vous votre bière ou soda préféré ? Pouvez-vous faire la différence entre Jupiler, Maes, Leffe ou Palm ? Ou entre Coca-Cola et Pepsi ?","Découvrez la puissance de vos sens en essayant de reconnaître différentes saveurs et odeurs."],gallery:["smaaktest/smaaktest-2.jpg","smaaktest/smaaktest-3.jpg","smaaktest/smaaktest-4.jpg","smaaktest/smaaktest-5.jpg","smaaktest/smaaktest-6.jpg","smaaktest/smaaktest-7.jpg"],isGame:false,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/fr/smaaktest.md",
							rawData: undefined,
						};
