const id = "en/kunstsmeden.md";
						const collection = "activities";
						const slug = "en/kunstsmeden";
						...
						const data = {title:"Artistic Blacksmithing",description:"Blacksmithing is a very old profession and has produced many masterpieces throughout history.",image:"kunstsmeden/kunstsmeden-1.jpg",categories:["workshop","outdoor","actief"],duration:"2 - 3 hours",groupSize:"Max. 20 participants per session",availability:"All year round",priority:2,features:["Experienced blacksmith","A unique creation to take home","Safety goggles"],gallery:["kunstsmeden/kunstsmeden-2.jpg","kunstsmeden/kunstsmeden-3.jpg","kunstsmeden/kunstsmeden-4.jpg","kunstsmeden/kunstsmeden-5.jpg","kunstsmeden/kunstsmeden-6.jpg","kunstsmeden/kunstsmeden-7.jpg"],isGame:false,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/en/kunstsmeden.md",
							rawData: undefined,
						};
