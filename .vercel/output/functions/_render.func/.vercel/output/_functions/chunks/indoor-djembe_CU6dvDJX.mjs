const id = "fr/indoor-djembe.md";
						const collection = "activities";
						const slug = "fr/indoor-djembe";
						...
						const data = {title:"Atelier de Djembé (Indoor)",description:"Faire de la musique en équipe crée une expérience unique et génère un sentiment de groupe positif.",image:"indoor-djembe/indoor-djembe-1.jpg",categories:["workshop"],duration:"30 minutes - 2 heures",groupSize:"Maximum 250 personnes",availability:"Sur demande",priority:7,features:["esprit","musique","culture"],gallery:["indoor-djembe/indoor-djembe-2.jpg","indoor-djembe/indoor-djembe-3.jpg","indoor-djembe/indoor-djembe-4.jpg","indoor-djembe/indoor-djembe-5.jpg","indoor-djembe/indoor-djembe-6.jpg","indoor-djembe/indoor-djembe-7.jpg"],isGame:false,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/fr/indoor-djembe.md",
							rawData: undefined,
						};
