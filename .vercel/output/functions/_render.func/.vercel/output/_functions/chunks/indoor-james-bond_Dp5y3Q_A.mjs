const id = "nl/indoor-james-bond.md";
						const collection = "activities";
						const slug = "nl/indoor-james-bond";
						...
						const data = {title:"Spy-academy/James Bond (Indoor)",description:"We gaan op zoek naar het ultieme team van collega's om de rol van 's werelds meest bekende spion op zich te nemen.",image:"indoor-james-bond/indoor-james-bond-1.jpg",categories:["indoor","innovaction"],duration:"2 - 5 uur",groupSize:"8 - 1000 personen",availability:"Op aanvraag",priority:20,features:["Schermen","Morse code","Schieten..."],gallery:["indoor-james-bond/indoor-james-bond-2.jpg","indoor-james-bond/indoor-james-bond-3.jpg","indoor-james-bond/indoor-james-bond-4.jpg","indoor-james-bond/indoor-james-bond-5.jpg","indoor-james-bond/indoor-james-bond-6.jpg","indoor-james-bond/indoor-james-bond-7.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/nl/indoor-james-bond.md",
							rawData: undefined,
						};
