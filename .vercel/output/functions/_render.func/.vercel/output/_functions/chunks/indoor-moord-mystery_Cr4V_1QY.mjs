...
const html = "<p>Tijdens dit interactieve spel worden jullie detectives in een mysterie vol intriges, verdachten en verborgen aanwijzingen. Met leuke opdrachten die helemaal passen bij de Cluedo-periode, worden jullie uitgedaagd om verbanden te leggen tussen een wapen, plaats of verdachte.</p>\n<p>Iedere deelnemer krijgt een stijlvolle detectivehoed en een vergrootglas om helemaal in de sfeer te komen. Het programma is volledig aanpasbaar voor zowel binnen als buiten, afhankelijk van jullie voorkeur.</p>\n<p>Ga samen op zoek naar de dader en beleef een teambuilding vol plezier, spanning en samenwerking!</p>";
				...
				const frontmatter = {"title":"Moord Mystery (Indoor)","description":"Beleef een onvergetelijke teambuilding met een spannend murder-mystery in Cluedo-stijl!","image":"indoor-moord-mystery/indoor-moord-mystery-1.jpg","priority":15,"isGame":true,"features":["Communicatiespel","Schietvaardigheid","Croquet in Cluedo-stijl"],"gallery":["indoor-moord-mystery/indoor-moord-mystery-2.jpg","indoor-moord-mystery/indoor-moord-mystery-3.jpg","indoor-moord-mystery/indoor-moord-mystery-4.jpg","indoor-moord-mystery/indoor-moord-mystery-5.jpg","indoor-moord-mystery/indoor-moord-mystery-6.jpg","indoor-moord-mystery/indoor-moord-mystery-7.jpg"],"categories":["indoor"],"duration":"2 - 5 uur","groupSize":"6 -1000 personen","availability":"Op aanvraag"};
				const file = "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/nl/indoor-moord-mystery.md";
				const url = undefined;
				function rawContent() {
