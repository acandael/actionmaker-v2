const id = "nl/alpacaworkshop.md";
						const collection = "activities";
						const slug = "nl/alpacaworkshop";
						...
						const data = {title:"Alpaca Workshop",description:"Deze fijngevoelige dieren geven directe feedback op de mens en hoe die zich gedraagt",image:"alpacaworkshop/alpacaworkshop-1.jpg",categories:["workshop"],duration:"2-3 uur",groupSize:"1-15 personen",availability:"Op aanvraag",priority:10,features:["teamgeest","communicatie","leiderschap"],gallery:["alpacaworkshop/alpacaworkshop-2.jpg","alpacaworkshop/alpacaworkshop-3.jpg","alpacaworkshop/alpacaworkshop-4.jpg","alpacaworkshop/alpacaworkshop-5.jpg","alpacaworkshop/alpacaworkshop-6.jpg","alpacaworkshop/alpacaworkshop-7.jpg"],isGame:false,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/nl/alpacaworkshop.md",
							rawData: undefined,
						};
