const id = "en/middeleeuwse-dag.md";
						const collection = "activities";
						const slug = "en/middeleeuwse-dag";
						...
						const data = {title:"Medieval Day",description:"Dive into the enchanting atmosphere of the Middle Ages with this immersive team building",image:"middeleeuwse-dag/middeleeuwse-dag-1.jpg",categories:["outdoor","actief"],duration:"2.5 hours",groupSize:"8 - 1000 people",availability:"All year round",priority:22,features:["Crossbow shooting","Axe throwing","Purse throwing","Fencing","Horseshoe throwing","The Monk's Secret"],gallery:["middeleeuwse-dag/middeleeuwse-dag-2.jpg","middeleeuwse-dag/middeleeuwse-dag-3.jpg","middeleeuwse-dag/middeleeuwse-dag-4.jpg","middeleeuwse-dag/middeleeuwse-dag-5.jpg","middeleeuwse-dag/middeleeuwse-dag-6.jpg","middeleeuwse-dag/middeleeuwse-dag-7.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/en/middeleeuwse-dag.md",
							rawData: undefined,
						};
