const id = "en/space-games.md";
						const collection = "activities";
						const slug = "en/space-games";
						...
						const data = {title:"The Space Games",description:"Where the future takes center stage and space is your playground.",image:"space-games/space-games-1.jpg",categories:["indoor","innovaction"],duration:"2-3 hours",groupSize:"8-50 people",availability:"On request",priority:19,features:["Laser fencing","Spaceship repair","Space communication"],gallery:["space-games/space-games-2.jpg","space-games/space-games-3.jpg","space-games/space-games-4.jpg","space-games/space-games-5.jpg","space-games/space-games-6.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/en/space-games.md",
							rawData: undefined,
						};
