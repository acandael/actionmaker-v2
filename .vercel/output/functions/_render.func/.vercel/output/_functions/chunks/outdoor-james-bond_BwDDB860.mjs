const id = "en/outdoor-james-bond.md";
						const collection = "activities";
						const slug = "en/outdoor-james-bond";
						...
						const data = {title:"Spy Academy/James Bond (Outdoor)",description:"We're looking for the ultimate team of colleagues to take on the role of the world's most famous spy.",image:"outdoor-james-bond/outdoor-james-bond-1.jpg",categories:["outdoor","innovaction"],duration:"2 - 5 hours",groupSize:"8 - 1000 people",availability:"On request",priority:23,features:["Fencing","Morse code","Shooting..."],gallery:["outdoor-james-bond/outdoor-james-bond-2.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/en/outdoor-james-bond.md",
							rawData: undefined,
						};
