const id = "fr/kunstsmeden.md";
						const collection = "activities";
						const slug = "fr/kunstsmeden";
						...
						const data = {title:"Atelier de Forge",description:"La forge est un métier très ancien qui a produit de nombreux objets dans le passé",image:"kunstsmeden/kunstsmeden-1.jpg",categories:["workshop","actief"],duration:"2 - 3 heures",groupSize:"20 personnes maximum",availability:"Toute l'année",priority:2,features:["Forgeron expérimenté","Une création unique à emporter","Lunettes de sécurité"],gallery:["kunstsmeden/kunstsmeden-2.jpg","kunstsmeden/kunstsmeden-3.jpg","kunstsmeden/kunstsmeden-4.jpg","kunstsmeden/kunstsmeden-5.jpg","kunstsmeden/kunstsmeden-6.jpg","kunstsmeden/kunstsmeden-7.jpg"],isGame:false,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/fr/kunstsmeden.md",
							rawData: undefined,
						};
