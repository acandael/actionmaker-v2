const id = "fr/outdoor-james-bond.md";
						const collection = "activities";
						const slug = "fr/outdoor-james-bond";
						...
						const data = {title:"Spy-academy/James Bond (Outdoor)",description:"Nous recherchons l'équipe ultime de collègues pour incarner l'espion le plus célèbre au monde.",image:"outdoor-james-bond/outdoor-james-bond-1.jpg",categories:["outdoor","innovaction"],duration:"2 - 5 heures",groupSize:"8 - 1000 personnes",availability:"Sur demande",priority:23,features:["Escrime","Code Morse","Tir..."],gallery:["outdoor-james-bond/outdoor-james-bond-2.jpg"],isGame:true,isCityGame:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/anthonycandaele/Projects/ActionMaker/website/src/content/activities/fr/outdoor-james-bond.md",
							rawData: undefined,
						};
