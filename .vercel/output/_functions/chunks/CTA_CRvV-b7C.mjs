import { c as createComponent, b as createAstro, m as maybeRenderHead, r as renderComponent, f as renderScript, a as renderTemplate, e as addAttribute, l as renderSlot } from './astro/server_BQZACKfH.mjs';
import 'kleur/colors';
import { $ as $$Image } from './_astro_assets_uY909pE1.mjs';
import { g as getLangFromUrl, u as useTranslations, B as Button, a as getCollection } from './Layout_DuKO7j-Q.mjs';
...
/* empty css                         */
import { C as Card, a as CardContent } from './card_hFKS_J0s.mjs';
import 'clsx';

const heroImage = new Proxy({"src":"/_astro/hero.DEXURzLn.jpg","width":2878,"height":1621,"format":"jpg"}, {
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="relative min-h-screen flex items-center -mt-[64px]"> <div class="absolute inset-0 z-0"> ${renderComponent($$result, "Image", $$Image, { "src": heroImage, "alt": "Team building activities", "class": "w-full h-full object-cover", "quality": "high" })} <div class="absolute inset-0 bg-linear-to-r from-black/60 via-black/50 to-transparent"></div> </div> <div class="relative z-10 max-w-7xl mx-auto px-4 py-24 mt-16"> <div class="max-w-3xl"> <h1 class="text-balance text-4xl md:text-6xl font-bold text-white mb-6"> ${t("home.hero.title")} </h1> <p class="text-xl text-white/90 mb-8"> ${t("home.hero.subtitle")} </p> <div> ${renderComponent($$result, "Button", Button, { "className": "bg-red-600 hover:bg-red-700 text-white group h-auto py-4 px-8 text-lg rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300" }, { "default": ($$result2) => renderTemplate` <a${addAttribute(teamBuildingsUrl, "href")} class="flex items-center gap-2"> ${t("home.hero.cta")} ${renderComponent($$result2, "ArrowRight", ArrowRight, { "className": "w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" })} </a> ` })} </div> </div> </div> </section> ${renderScript($$result, "/Users/anthonycandaele/Projects/ActionMaker/website/src/components/Hero.astro?astro&type=script&index=0&lang.ts")}`;
...
const $$ClientLogos = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="space-y-16" data-astro-cid-sodmizi3> <h3 class="text-center text-xl text-muted-foreground animate-fade-in" data-astro-cid-sodmizi3> ${t("testimonials.logos-title")} </h3> <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8" data-astro-cid-sodmizi3> ${logos.map((logo, index) => {
    ...
    return renderTemplate`${renderComponent($$result, "Card", Card, { "className": "group relative h-32 overflow-hidden bg-white hover:bg-muted/50 transition-all duration-500 ease-out", "data-client-logo": true, "data-index": index, "data-astro-cid-sodmizi3": true }, { "default": ($$result2) => renderTemplate`<div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-500" data-astro-cid-sodmizi3> <div class="absolute inset-0 bg-linear-to-br from-red-500/10 via-red-500/5 to-transparent" data-astro-cid-sodmizi3></div> </div> <div class="relative h-full px-8 py-6 flex items-center justify-center" data-astro-cid-sodmizi3> ${renderComponent($$result2, "Image", $$Image, { "src": imageData, "alt": logo.data.name, "width": 120, "height": 60, "class": "w-auto h-16 grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transform group-hover:scale-110 transition-all duration-500 ease-out", "data-astro-cid-sodmizi3": true })} </div> <div class="absolute inset-x-0 bottom-0 h-[2px] bg-linear-to-r from-transparent via-red-500/0 to-transparent group-hover:via-red-500/40 transition-all duration-700 ease-in-out" data-astro-cid-sodmizi3></div> <div class="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-transparent group-hover:border-red-500/20 transition-all duration-500 ease-out" data-astro-cid-sodmizi3></div> <div class="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-transparent group-hover:border-red-500/20 transition-all duration-500 ease-out" data-astro-cid-sodmizi3></div> ` })}`;
...
const ctaImage = new Proxy({"src":"/_astro/cta.C5g1hhgw.jpg","width":1200,"height":900,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/anthonycandaele/Projects/ActionMaker/website/src/assets/cta.jpg";
							}
